    ...
    <section className="standard-screen operation-screen">
      <div className="operation-hero panel">
        <div>
          ...
          <p>{operation.canOperate ? 'Operações liberadas para vendas e movimentos financeiros.' : operation.message}</p>
        </div>
        ...
        <section className="operation-actions panel">
          ...
          <div className="operation-action-list">
            <ActionButton
              icon={PlayCircle}
              title="Abrir dia"
              detail="Inicia a data operacional da farmácia"
            ...
            <ActionButton
              icon={PlayCircle}
              title="Abrir turno"
              detail="Libera vendas e despesas do período"
